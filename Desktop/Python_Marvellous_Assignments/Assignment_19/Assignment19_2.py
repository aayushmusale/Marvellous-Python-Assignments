...
def DirectoryWatcher(DirectoryName, OldExtention, NewExtention):
    ...
    for FolderName,SubFolderNames,FileNames in os.walk(DirectoryName):
         for fname in FileNames:
              ...
              if(str(fname).endswith(OldExtention)):
                   OldFilename = os.path.splitext(fname)[0]  #use to seperate The Extension
                   NewFilename = OldFilename + NewExtention
...
def  main():
    ...
    if(len(sys.argv)== 2): 
        if((sys.argv[1] == "--h") or (sys.argv[1] == "--H")):
            ...
            print("ScripName.py NameOfDirectory Expected_Extention Expected_Extention2 ")
